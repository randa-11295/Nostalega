...
const formPartStyle = {transition: '.5s' ,
                      // background : "red" ,
                      width :  {xs : '100%' , md :  '60%'} ,
                      height : {xs :'60%' , md : '100%' } ,
                      position : "absolute",
  ...
  return (
      ...
      <Box  sx={boxStyle}  >
            ...
            <Box sx={{  left :{ xs : "0" , md : secLeft,}  , 
                         top : { xs : secTop , md : "0" },
                       ...formPartStyle
                    }} >

             Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempor
             e explicabo laborum, corporis dolorem maxime minima alias! 
             Dignissimos alias sint ab corrupti recusandae libero vero! 
             Fugiat perspiciatis id nulla aliquid esse.
             Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempor
             e explicabo laborum, corporis dolorem maxime minima alias! 
             Dignissimos alias sint ab corrupti recusandae libero vero! 
             Fugiat perspiciatis id nulla aliquid esse.
